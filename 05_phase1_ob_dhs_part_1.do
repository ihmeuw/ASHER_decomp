...
* Author: NAME
* Description: This do file conducts an Oaxaca-Blinder analysis for 4 countries using two years of data (baseline and endline): part 1 of two part model with outcome if sexual activity 
*
