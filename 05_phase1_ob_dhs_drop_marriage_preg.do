...
import delimited ob_input_prepped_df_outcome_c_marriage_preg_drop_dhs.csv
...
gen file_name_coef = "alt_dhs_oaxaca_15_19_coef_detail_marriage_preg_drop_outcome_c_baseline_ref_endline_coef_" +  "`country_code'" + ".csv"
local file_name_coef = file_name_coef[1]

gen file_name_ci = "alt_dhs_oaxaca_15_19_ci_detail_marriage_preg_drop_outcome_c_baseline_ref_endline_coef_" +  "`country_code'" + ".csv"
...
gen file_name_ci_endline = "alt_dhs_oaxaca_15_19_ci_detail_endline_marriage_preg_drop_outcome_c_" +  "`country_code'" + ".csv"
