...
## create diagnostic plots for method mix in ASHER decomp: with DHS as endline and by marital status 
rm(list=ls())
...
ggsave(file.path(out.dir, 'method_mix_all_15_19_by_marital_dhs.png'), width = 10, height =10)
...
title <- paste0('method_mix_15_19_', cur_country, '_by_marital_dhs.png')
...
ggsave(file.path(out.dir, 'method_mix_all_15_24_by_marital_dhs.png'), width = 10, height =10)
...
for (cur_country in c("cm", "mw", "np", "rw",'gh')){
  ...
  title <- paste0('method_mix_15_24_', cur_country, '_by_marital_dhs.png')
  ggsave(file.path(out.dir, title), width = 10, height =10)
}
## 15-49 ---------
...
ggsave(file.path(out.dir, 'method_mix_all_15_49_by_marital_dhs.png'), width = 10, height =10)
...
for (cur_country in c("cm", "mw", "np", "rw",'gh')){
  ...
  title <- paste0('method_mix_15_49_', cur_country, '_by_marital_dhs.png')
  ggsave(file.path(out.dir, title), width = 10, height =10)
}
