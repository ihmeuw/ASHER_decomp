...
# Cameroon
extract_data("/snfs1/DATA/UNICEF_MICS/CMR/2000/CMR_MICS2_2000_WN_Y2008M09D23.DTA", "cm")
extract_data("/snfs1/DATA/UNICEF_MICS/CMR/2006/CMR_MICS3_2006_WN_Y2009M04D06.DTA", "cm")
extract_data("/snfs1/DATA/UNICEF_MICS/CMR/2014/CMR_MICS5_2014_WN_Y2017M05D16.DTA", "cm")

# Nepal
extract_data("/snfs1/DATA/UNICEF_MICS/NPL/2010/NPL_MICS4_2010_WN_Y2012M11D19.DTA", "np")
extract_data("/snfs1/DATA/UNICEF_MICS/NPL/2014/NPL_MICS5_2014_WN_Y2015M06D08.DTA", "np")
extract_data("/ihme/limited_use/IDENT/PROJECT_FOLDERS/UNICEF_MICS/NPL/2019/NPL_MICS6_2019_WN_Y2020M12D07.DTA", "np")

# Malawi
extract_data("/snfs1/DATA/UNICEF_MICS/MWI/2006/MWI_MICS3_2006_WN_Y2008M09D23.DTA", "mw")
extract_data("/snfs1/DATA/UNICEF_MICS/MWI/2013_2014/MWI_MICS5_2013_2014_WN_Y2015M08D14.DTA", "mw")
extract_data("/ihme/limited_use/IDENT/PROJECT_FOLDERS/UNICEF_MICS/MWI/2019_2020/MWI_MICS6_2019_2020_WN_Y2022M01D31.DTA", "mw")

# Ghana
extract_data("/snfs1/DATA/UNICEF_MICS/GHA/2006/GHA_MICS3_2006_WN_Y2008M09D23.DTA", "gh")
extract_data("/snfs1/DATA/UNICEF_MICS/GHA/2011/GHA_MICS4_2011_WN_Y2013M10D04.DTA", "gh")
extract_data("/ihme/limited_use/IDENT/PROJECT_FOLDERS/UNICEF_MICS/GHA/2017_2018/GHA_MICS6_2017_2018_WN_Y2020M04D10.DTA", "gh")

# Rwanda
extract_data("/snfs1/DATA/UNICEF_MICS/RWA/2000/RWA_MICS2_2000_WN_Y2008M09D23.DTA", "rw")
