#-------------------Header------------------------------------------------
# Author: Corinne Bintz, last updated by Olivia Angelino 2/5/2024
# Project: ASHER
...
# Cameroon
extract_data("/snfs1/DATA/UNICEF_MICS/CMR/2014/CMR_MICS5_2014_BH_Y2017M05D16.DTA", "cm")

# Nepal
extract_data("/snfs1/DATA/UNICEF_MICS/NPL/2014/NPL_MICS5_2014_BH_Y2015M06D08.DTA", "np")
extract_data("/ihme/limited_use/IDENT/PROJECT_FOLDERS/UNICEF_MICS/NPL/2019/NPL_MICS6_2019_BH_Y2020M12D07.DTA", "np")

# Malawi
extract_data("/snfs1/DATA/UNICEF_MICS/MWI/2006/MWI_MICS3_2006_BH_Y2008M09D23.DTA", "mw")
extract_data("/snfs1/DATA/UNICEF_MICS/MWI/2013_2014/MWI_MICS5_2013_2014_BH_Y2015M08D14.DTA", "mw")
extract_data("/ihme/limited_use/IDENT/PROJECT_FOLDERS/UNICEF_MICS/MWI/2019_2020/MWI_MICS6_2019_2020_BH_Y2022M01D31.DTA", "mw")

# Ghana
extract_data("/snfs1/DATA/UNICEF_MICS/GHA/2011/GHA_MICS4_2011_BH_Y2013M10D04.DTA", "gh")
extract_data("/ihme/limited_use/IDENT/PROJECT_FOLDERS/UNICEF_MICS/GHA/2017_2018/GHA_MICS6_2017_2018_BH_Y2020M04D10.DTA", "gh")
