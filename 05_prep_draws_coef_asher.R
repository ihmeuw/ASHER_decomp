...
# Prep coefficient draws for oaxaca-blinder decomp for ASHER: by region by country (sensitivity analysis)
...
create_draws <- function(cur_country){
  ...
  coef_dt <- fread(file.path(in.dir, paste0("alt_", endline, "_oaxaca_15_19_ci_detail_endline_", cur_country, ".csv")), fill = T)
