#-------------------Header------------------------------------------------
# Author: Corinne Bintz, last updated by Olivia Angelino 2/8/2024
# Project: ASHER
# Purpose: MICS wealth quintile prep code, adapted from dhs_school_attend_wealth_quintile_prep.R
# Date: 12/6/2023
# Notes:
#***************************************************************************
