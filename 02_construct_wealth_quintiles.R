#-------------------Header------------------------------------------------
# Author: Corinne Bintz, last updated by Olivia Angelino 2/13/24
# Project: ASHER
...
out.dir <- '/share/scratch/projects/hssa/asher/data/01_processed/wealth_quintile_construction'
...
process_wealth_quintile <- function(cur_country, baseline_endline = F, cohort = F) {
  ...
  if (baseline_endline == T) {
    ...
    # update out_dir
    out.dir <- '/share/scratch/projects/hssa/asher/data/01_processed/wealth_quintile_construction/baseline_endline'
  ...
  if (cohort == T) {
    ...
    # update out_dir
    out.dir <- '/share/scratch/projects/hssa/asher/data/01_processed/wealth_quintile_construction/cohort'
