#-------------------Header------------------------------------------------
# Author: Annie & Corinne, last updated by Olivia Angelino 2/9/2024
# Project: ASHER
...
# Cameroon
extract_data("/snfs1/DATA/DHS_PROG_DHS/CMR/2004/CMR_DHS4_2004_HH_CMHR44FL_Y2018M05D29.DTA", "cm")
extract_data("/snfs1/DATA/DHS_PROG_DHS/CMR/2011/CMR_DHS5_2011_HH_CMHR61FL_Y2018M06D11.DTA", "cm")
extract_data("/snfs1/DATA/DHS_PROG_DHS/CMR/2018_2019/CMR_DHS7_2018_2019_HH_CMHR71FL_Y2020M06D10.DTA", "cm")

# Ghana
extract_data("/snfs1/DATA/DHS_PROG_DHS/GHA/2003/GHA_DHS4_2003_HH_GHHR4BFL_Y2018M10D15.DTA", "gh")
extract_data("/snfs1/DATA/DHS_PROG_DHS/GHA/2008/GHA_DHS5_2008_HH_GHHR5AFL_Y2018M10D15.DTA", "gh")
extract_data("/snfs1/DATA/DHS_PROG_DHS/GHA/2014/GHA_DHS6_2014_HH_GHHR72FL_Y2018M12D10.DTA", "gh")
extract_data("/snfs1/DATA/DHS_PROG_DHS/GHA/2022_2023/GHA_DHS8_2022_2023_HH_GHHR8AFL_Y2024M01D22.DTA", "gh")

# Malawi
extract_data("/snfs1/DATA/DHS_PROG_DHS/MWI/2000/MWI_DHS4_2000_HH_MWHR41FL_Y2019M01D07.DTA", "mw")
extract_data("/snfs1/DATA/DHS_PROG_DHS/MWI/2004_2005/MWI_DHS4_2004_2005_HH_MWHR4EFL_Y2018M12D10.DTA", "mw")
extract_data("/snfs1/DATA/DHS_PROG_DHS/MWI/2010/MWI_DHS6_2010_HH_MWHR61FL_Y2018M12D10.DTA", "mw")
extract_data("/snfs1/DATA/DHS_PROG_DHS/MWI/2015_2016/MWI_DHS7_2015_2016_HH_MWHR7AFL_Y2019M12D11.DTA", "mw")

# Nepal
extract_data("/snfs1/DATA/DHS_PROG_DHS/NPL/2001/NPL_DHS4_2001_HH_NPHR41FL_Y2019M02D19.DTA", "np")
extract_data("/snfs1/DATA/DHS_PROG_DHS/NPL/2006/NPL_DHS5_2006_HH_NPHR51FL_Y2018M11D05.DTA", "np")
extract_data("/snfs1/DATA/DHS_PROG_DHS/NPL/2011/NPL_DHS6_2011_HH_NPHR60FL_Y2018M11D05.DTA", "np")
extract_data("/snfs1/DATA/DHS_PROG_DHS/NPL/2016_2017/NPL_DHS7_2016_2017_HH_NPHR7HFL_Y2018M11D05.DTA", "np")
extract_data("/snfs1/DATA/DHS_PROG_DHS/NPL/2022/NPL_DHS8_2022_HH_NPHR81FL_Y2023M06D23.DTA", "np")

# Rwanda
extract_data("/snfs1/DATA/DHS_PROG_DHS/RWA/2000/RWA_DHS4_2000_HH_RWHR41FL_Y2019M03D18.DTA", "rw")
extract_data("/snfs1/DATA/DHS_PROG_DHS/RWA/2005/RWA_DHS4_2005_HH_RWHR53FL_Y2019M03D18.DTA", "rw")
extract_data("/snfs1/DATA/DHS_PROG_DHS/RWA/2010_2011/RWA_DHS6_2010_2011_HH_RWHR61FL_Y2019M04D16.DTA", "rw")
extract_data("/snfs1/DATA/DHS_PROG_DHS/RWA/2014_2015/RWA_DHS7_2014_2015_HH_RWHR70FL_Y2019M04D16.DTA", "rw")
extract_data("/snfs1/DATA/DHS_PROG_DHS/RWA/2019_2020/RWA_DHS8_2019_2020_HH_RWHR81FL_Y2021M10D05.DTA", "rw")
