...
out.dir <- file.path('/share/scratch/projects/hssa/asher/phase1/results/shapely/', Sys.Date())
dir.create(out.dir, showWarnings = FALSE)
out.dir <- file.path('/share/scratch/projects/hssa/asher/phase1/results/shapely/', Sys.Date(), '/ob_vars_only')
dir.create(out.dir, showWarnings = FALSE)
