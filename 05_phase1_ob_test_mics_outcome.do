...
* The outcome excludes terminations, miscarriages, and stillbirths
*
...
gen file_name_coef = "alt_dhs_oaxaca_15_19_coef_detail_mics_outcome_c_baseline_ref_endline_coef_" +  "`country_code'" + ".csv"
local file_name_coef = file_name_coef[1]

gen file_name_ci = "alt_dhs_oaxaca_15_19_ci_detail_mics_outcome_c_baseline_ref_endline_coef_" +  "`country_code'" + ".csv"
...
gen file_name_ci_endline = "alt_dhs_oaxaca_15_19_ci_detail_endline_mics_outcome_c_" +  "`country_code'" + ".csv"
local file_name_ci_endline = file_name_ci_endline[1]

* store confidence intervals
esttab test_endline using "`file_name_ci_endline'", ci(4) replace

gen file_name_ci_endline_table = "alt_dhs_oaxaca_15_19_ci_detail_endline_table_mics_outcome_c_" +  "`country_code'" + ".csv"
