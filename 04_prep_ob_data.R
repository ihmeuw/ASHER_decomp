...
in.dir <- '/share/scratch/projects/hssa/asher/data/03_prepped/baseline_endline'
...
if (endline == "DHS"){
  variables <- c(variable_list$Variable, "country", 'year','any_birth_preg_2_yr_dhs', 'cluster', 'pweight', 'mcpr')
} else{
  variables <- c(variable_list$Variable, "country", 'year','any_birth_preg_2_yr_mics', 'cluster', 'pweight', 'mcpr')
}
