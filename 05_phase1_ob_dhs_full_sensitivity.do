...
import delimited ob_input_prepped_df_outcome_c_ob_full_sensitivity_dhs.csv
...
oaxaca outcome_c_dhs urban mean_yrs_schooling_head age educ_single_yrs  curr_cohabit  unmet_need wealth_dummies1 wealth_dummies2 wealth_dummies3 wealth_dummies4 wealth_dummies5 had_intercourse_unmarried beating_just, by(baseline) categorical(wealth_dummies1 wealth_dummies2 wealth_dummies3 wealth_dummies4 wealth_dummies5) weight(1) detail svy noisily relax

estimates store test

gen file_name_coef = "alt_dhs_oaxaca_15_19_coef_detail_full_sensitivity_outcome_c_baseline_ref_endline_coef_" +  "`country_code'" + ".csv"
local file_name_coef = file_name_coef[1]

gen file_name_ci = "alt_dhs_oaxaca_15_19_ci_detail_full_sensitivity_outcome_c_baseline_ref_endline_coef_" +  "`country_code'" + ".csv"
...
keep if baseline == 0
svy: regress outcome_c_dhs urban mean_yrs_schooling_head age educ_single_yrs  curr_cohabit  unmet_need wealth_dummies2 wealth_dummies3 wealth_dummies4 wealth_dummies5 had_intercourse_unmarried beating_just  

estimates store test_endline

gen file_name_ci_endline = "alt_dhs_oaxaca_15_19_ci_detail_endline_full_sensitivity_outcome_c_" +  "`country_code'" + ".csv"
